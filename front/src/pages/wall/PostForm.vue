...
<template>
                    ...
                    <div class="flex items-center space-x-5">
                        <div class="flex items-center">
                            <label for="file-input"
                                ...
                                <PhotoIcon class="h-5 w-5 text-tertiary-default hover:text-tertiary-dark cursor-pointer" aria-hidden="true" />
    ...
    <div class="relative mt-4 mb-4">
        <div class="absolute inset-0 flex items-center" aria-hidden="true">
            <div class="w-full border-t border-secondary-default" />
        </div>
        <div class="relative flex justify-center">
            <span class="bg-white dark:bg-black px-2 text-sm text-tertiary-default">Post récents</span>
        </div>
    </div>
</template>
